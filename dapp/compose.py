...
def handle_advance(data):
    ...
    logger.info(f"voucher_class voucher_class.hexpayload {voucher_class.hexpayload}")

    voucher = {"destination": voucher_class.destination, "payload": voucher_class.hexpayload}
